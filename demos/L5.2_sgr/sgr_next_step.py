...
Простейший SGR — один проход по жёсткой схеме: модель заполняет поля, мы исполняем
одно выражение. Предсказуемо, но негибко: один шаг, никакой адаптации к тому, что
вскрылось в данных.
